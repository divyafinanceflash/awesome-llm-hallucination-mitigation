...
## Types of LLM Hallucinations
  ...
  --------------- ----------------------------------- ---------------------
  Factual         Model generates incorrect facts     Saying Eiffel Tower
  hallucination                                       is in Berlin

  Citation        Fabricated research papers or       Inventing academic
  hallucination   sources                             references

  Reasoning       Incorrect logical reasoning         Wrong math logic
  hallucination                                       

  Numeric         Produces incorrect calculations     Financial
  hallucination                                       miscalculations

  Instruction     Ignores prompt constraints          Asked not to guess
  hallucination                                       but still guesses

  Entity          Invents companies or people         Fictional startups
  hallucination                                       

  Temporal        Incorrect timelines                 Saying GPT‑4 launched
  hallucination                                       in 2019

  Context         Adds info not in provided context   RAG answers beyond
  hallucination                                       documents

  Code            Invents APIs or functions           Non‑existent Python
  hallucination                                       libraries

  Specification   Invents product features            Claiming tools
  hallucination                                       support features they
                                                      do not
  -------------------------------------------------------------------------
...
## Open Source Tools
  ...
  Arize Phoenix           LLM monitoring          https://github.com/Arize-ai/phoenix
  ---------------------------------------------------------------------------------------------
